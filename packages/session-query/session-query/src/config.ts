...
/** Default logical-event ceiling across retained cold observations. */
export const SESSION_QUERY_DEFAULT_PREPARED_SESSION_CACHE_MAX_EVENTS = 1_000_000
...
export interface Config {
  ...
  /** Maximum concurrent persisted-log reads in one batch read. Defaults to 1. */
  ...
  /** Maximum logical events retained across cold observations; pinned leases survive eviction. Defaults to 1,000,000. */
