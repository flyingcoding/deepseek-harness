...
| `persistedReadConcurrency` | `1` | Concurrent persisted-log reads in one batch title read |
| `preparedSessionCacheSize` | `5` | Cold prepared-Session observations retained for reuse across `observeSession` reads |
| `preparedSessionCacheMaxEvents` | `1,000,000` | Logical-event ceiling across cached cold observations; active leases remain pinned |
