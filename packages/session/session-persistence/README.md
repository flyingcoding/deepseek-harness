...
| [`src/preparations.ts`](src/preparations.ts) | Entry-count and logical-event bounded retention of unpublished Session preparations for resume reuse, with leases that pin active observations |
