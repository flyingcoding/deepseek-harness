  ...
  },
  {
    ...
    methods: [
      ...
      },
      {
        ...
        parameters: [{ name: 'id', description: 'persisted session to read.' }, { name: 'beforeSeq', description: 'exclusive upper log offset; omitted selects the tail.' }, { name: 'maxEvents', description: 'maximum logical events returned.' }, { name: 'signal', description: 'optional cancellation for backend work.' }],
